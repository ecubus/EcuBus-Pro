        ...
        <tr>
          <template v-for="(_, idx) in rule.col">
            <td
              ...
              v-bind="
                lattice[pid][idx]
                  ? { colspan: lattice[pid][idx].colspan, rowspan: lattice[pid][idx].rowspan }
                  : {}
              "
                        ...
                        <template #dropdown>
                          <el-dropdown-menu>
                            ...
                            <el-dropdown-item
                              divided
                              :disabled="
                                !(lattice[pid][idx].layout && lattice[pid][idx].layout.col > 1)
                              "
                            ...
                            <el-dropdown-item
                              :disabled="
                                !(lattice[pid][idx].layout && lattice[pid][idx].layout.row > 1)
                              "
