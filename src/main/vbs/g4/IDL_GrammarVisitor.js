...
export default class IDL_GrammarVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	visitInterface_forward_dcl(ctx) {
	  return this.visitChildren(ctx);
	}
