...
Node.js 不是像 Python、Java 或 C/C++ 那样的编程语言。 Node.js 是一个运行时环境，类似于 Java 虚拟机，将 JavaScript 代码转换为机器代码。 它被全球数千名开发人员广泛使用，用于开发 I/O 密集型 Web 应用程序，如视频流网站、单页应用程序和其他 Web 应用程序。
