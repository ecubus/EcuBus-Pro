...
> EcuBus-Pro 的 SOME/IP 功能基于 [vSomeIP](https://github.com/GENIVI/vsomeip)。 有关配置细节不明确之处，请参阅 [vSomeIP 配置文档](https://github.com/COVESA/vsomeip/blob/master/documentation/vsomeipConfiguration.md)。
...
每个 SOME/IP 配置对应一个应用程序，需要一个应用程序 ID。 应用程序 ID 是应用程序的唯一标识符，范围为 1-65535。
...
> [!提示]
> 如果启用了服务发现，您可能需要在计算机上配置与多播相关的设置。
