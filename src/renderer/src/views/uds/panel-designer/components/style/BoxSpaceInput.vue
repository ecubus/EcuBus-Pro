  ...
  <div class="_fd-box-space-input">
    <div class="_padding">
      ...
      <input
        ...
        placeholder="        "
        :value="boxStyle.marginTop"
        type="text"
        @blur="(e) => setValue('margin', 'Top', e)"
        @input="(e) => change('marginTop', e)"
      />
      <input
        class="_fd-input _fd-right"
        placeholder="        "
        :value="boxStyle.marginRight"
        type="text"
        @blur="(e) => setValue('margin', 'Right', e)"
        @input="(e) => change('marginRight', e)"
      />
      <input
        class="_fd-input _fd-bottom"
        placeholder="        "
        :value="boxStyle.marginBottom"
        type="text"
        @blur="(e) => setValue('margin', 'Bottom', e)"
        @input="(e) => change('marginBottom', e)"
      />
      <input
        class="_fd-input _fd-left"
        placeholder="        "
        :value="boxStyle.marginLeft"
        type="text"
        @blur="(e) => setValue('margin', 'Left', e)"
        @input="(e) => change('marginLeft', e)"
      />
      <div class="_fd-help">
        <i
          class="fc-icon icon-link2"
          title="lock"
          :class="marginLock ? 'active' : ''"
          @click="lock('margin')"
        ></i>
      ...
      <div class="_margin">
        ...
        <input
          ...
          type="text"
          @blur="(e) => setValue('padding', 'Top', e)"
          @input="(e) => change('paddingTop', e)"
        />
        <input
          class="_fd-input _fd-right"
          placeholder="        "
          :value="boxStyle.paddingRight"
          type="text"
          @blur="(e) => setValue('padding', 'Right', e)"
          @input="(e) => change('paddingRight', e)"
        />
        <input
          class="_fd-input _fd-bottom"
          placeholder="        "
          :value="boxStyle.paddingBottom"
          type="text"
          @blur="(e) => setValue('padding', 'Bottom', e)"
          @input="(e) => change('paddingBottom', e)"
        />
        <input
          class="_fd-input _fd-left"
          placeholder="        "
          :value="boxStyle.paddingLeft"
          type="text"
          @blur="(e) => setValue('padding', 'Left', e)"
          @input="(e) => change('paddingLeft', e)"
        />
        <div class="_box"></div>
      </div>
    </div>
...
html.dark ._fd-box-space-input ._padding,
._fd-box-space-input ._margin {
...
._fd-box-space-input ._fd-input:hover,
._fd-box-space-input ._fd-input:focus {
  background-color: #ececec;
  opacity: 0.9;
  color: #262626;
}

._fd-box-space-input ._fd-left,
...
._fd-box-space-input ._padding-title,
._fd-box-space-input ._margin-title {
  position: absolute;
  top: 2px;
  left: 4px;
}
